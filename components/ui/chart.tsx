...
function ChartTooltipContent({
  ...
  const tooltipPayload = React.useMemo<ReadonlyArray<ChartTooltipPayload>>(
    () => payload ?? [],
    [payload],
  )
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        {tooltipPayload.map((item: ChartTooltipPayload, index: number) => {
...
function getPayloadConfigFromPayload(
  config: ChartConfig,
  payload: ChartTooltipPayload | LegendPayload | undefined,
  key: string,
) {
